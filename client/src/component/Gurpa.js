...
export default function Gurpa() {
  return (
    <div>
      <center>  <h1 style={{color:"blue"}}>Gurpa Hills</h1></center>
     <center> <img src="gurpa_755x450.jpeg" className='img-thumbnail' alt="..."  style={{marginBottom:"2rem"}}/></center>

      <p id="para10" style={{color:"green"}}>
