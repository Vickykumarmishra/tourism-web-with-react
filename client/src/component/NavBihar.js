 ...
 const {user}=useAuth0();
  ...
  return (
    ...
    <div style={{float:'left'}}>
        ...
        {isAuthenticated && <p style={{color:'white',marginRight:'1rem',float:'right',marginTop:"0.6rem"}}><img style={{borderRadius:'50%',height:'2rem'}} src={user.picture} alt={user.name} />User:{user.name} </p>}
