 ...
 const {user}=useAuth0();
  ...
  return (
    ...
    <div style={{float:'left'}}>
        ...
        {isAuthenticated && <p style={{color:'white',marginRight:'1rem',float:'right'}}><img style={{borderRadius:'50%',height:'3rem'}} src={user.picture} alt={user.name} />User:{user.name} </p>}
