...
export default function Cnvasacom() {
  ...
  <button class="btn btn-danger"  style={{marginLeft:"0.5em",marginBottom:"1rem"}} type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">AboutUs</button>
...
<button class="btn btn-danger"  onClick={dark} style={{marginLeft:"0.5rem",marginBottom:"1rem"}}>DarkMode</button>
<button class="btn btn-danger"  style={{marginLeft:"0.5rem",marginBottom:"1rem"}}>Contact</button>
...
<button class="btn btn-danger"  style={{marginLeft:"0.5rem",marginBottom:"1rem"}}>button6</button>
<button class="btn btn-danger"  style={{marginLeft:"0.5rem",marginBottom:"1rem"}}>button7</button>
<a  href="#" class="btn btn-danger"  style={{marginLeft:"0.5rem",marginBottom:"1rem"}}>button8</a>
    </div></center>
  )
}
