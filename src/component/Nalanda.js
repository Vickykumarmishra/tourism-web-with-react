...
export default function Nalanda() {
  return (
    <div>
      <center><h3 style={{color:"blue"}}>Ruins Of Nalanda</h3></center>

      <center><img src="nalanda-bihar_755x450.jpg" style={{marginBottom:"2rem"}} className='img-thumbnail' alt="..."/></center>
      <p id="para9" style={{color:"green"}}>
