...
function App() {
  return (
   ...
   {/* <Navbar   About="About company"/> */}  {/*navbar component ko import kiye hai yha par, fir <Navbar/> likhne se yaha navbar component show ho jayega.
...
{/*<Link to='/'><button className="btn btn-outline-success">Go to login page</button></Link>*/}{/*we can also make a component for these  links and can use where we want */}
...
<Routes>
  ...
  {/*<Route path='/TextForm' element={<TextForm/>}> </Route> */} {/*react ke URL  me '/TextForm 'likhne par textform component vala page khul jayega*/}
...
<Route path='/Mahaveer/' element={<Mahaveer/>}>
 ...
 <Route path='/*' element={<center><h1 className='namematch'>404 error!</h1></center>}></Route>
